...
///////////////////////////////////////////////////////////////////////////////
// CSetViewportOrg class -- safe GDI view port origin setting

class CSetViewportOrg : public CDCHandle
{
public:
	...
	CSetViewportOrg(HDC hdc, int x, int y)
	:	CDCHandle(hdc)
	{
		SetViewportOrg(x, y, &m_pt);
	}

	CSetViewportOrg(HDC hdc, const CPoint pt)
	:	CDCHandle(hdc)
	{
		SetViewportOrg(pt, &m_pt);
	}
